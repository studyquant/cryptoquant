...
class SwapAPI(Client):
    ...
    def get_specific_position(self, instrument_id):
        return self._request_without_params(
            GET, SWAP_POSITION + str(instrument_id) + "/position"
        )
    ...
    def get_ledger(self, instrument_id, after="", before="", limit="", type=""):
        ...
        return self._request_with_params(
            GET,
            SWAP_ACCOUNTS + "/" + str(instrument_id) + "/ledger",
            params,
            cursor=True,
        )
    ...
    def revoke_order(self, instrument_id, order_id="", client_oid=""):
        if order_id:
            return self._request_without_params(
                POST, SWAP_CANCEL_ORDER + str(instrument_id) + "/" + str(order_id)
            )
        elif client_oid:
            return self._request_without_params(
                POST, SWAP_CANCEL_ORDER + str(instrument_id) + "/" + str(client_oid)
            )
    ...
    def revoke_orders(self, instrument_id, ids="", client_oids=""):
        ...
        return self._request_with_params(
            POST, SWAP_CANCEL_ORDERS + str(instrument_id), params
        )
    ...
    def get_order_list(self, instrument_id, state, after="", before="", limit=""):
        ...
        if limit:
            params["limit"] = limit
        return self._request_with_params(
            GET, SWAP_ORDERS + "/" + str(instrument_id), params, cursor=True
        )

    def get_order_info(self, instrument_id, order_id="", client_oid=""):
        if order_id:
            return self._request_without_params(
                GET, SWAP_ORDERS + "/" + str(instrument_id) + "/" + str(order_id)
            )
        elif client_oid:
            return self._request_without_params(
                GET, SWAP_ORDERS + "/" + str(instrument_id) + "/" + str(client_oid)
            )
    ...
    def get_depth(self, instrument_id, size="", depth=""):
        ...
        if depth:
            params["depth"] = depth
        return self._request_with_params(
            GET, SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/depth", params
        )
    ...
    def get_specific_ticker(self, instrument_id):
        return self._request_without_params(
            GET, SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/ticker"
        )
    ...
    def get_trades(self, instrument_id, after="", before="", limit=""):
        ...
        return self._request_with_params(
            GET,
            SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/trades",
            params,
            cursor=True,
        )
    ...
    def get_kline(self, instrument_id, granularity="", start="", end=""):
        ...
        # 按时间倒叙 即由结束时间到开始时间
        return self._request_with_params(
            GET, SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/candles", params
        )
    ...
    def get_index(self, instrument_id):
        return self._request_without_params(
            GET, SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/index"
        )
    ...
    def get_holds(self, instrument_id):
        return self._request_without_params(
            GET, SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/open_interest"
        )

    def get_limit(self, instrument_id):
        return self._request_without_params(
            GET, SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/price_limit"
        )
    ...
    def get_liquidation(self, instrument_id, status, froms="", to="", limit=""):
        ...
        if limit:
            params["limit"] = limit
        return self._request_with_params(
            GET, SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/liquidation", params
        )

    def get_holds_amount(self, instrument_id):
        return self._request_without_params(
            GET, SWAP_ACCOUNTS + "/" + str(instrument_id) + "/holds"
        )
    ...
    def get_order_algos(
        ...
        if limit:
            params["limit"] = limit
        return self._request_with_params(
            GET, SWAP_GET_ORDER_ALGOS + str(instrument_id), params
        )
    ...
    def get_funding_time(self, instrument_id):
        return self._request_without_params(
            GET, SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/funding_time"
        )

    def get_mark_price(self, instrument_id):
        return self._request_without_params(
            GET, SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/mark_price"
        )
    ...
    def get_historical_funding_rate(self, instrument_id, limit=""):
        ...
        return self._request_with_params(
            GET,
            SWAP_INSTRUMENTS + "/" + str(instrument_id) + "/historical_funding_rate",
            params,
        )
