...
class LeverAPI(Client):
    ...
    def get_specific_account(self, instrument_id):
        return self._request_without_params(
            GET, LEVER_COIN_ACCOUNT + str(instrument_id)
        )
    ...
    def get_ledger_record(self, instrument_id, after="", before="", limit="", type=""):
        ...
        return self._request_with_params(
            GET,
            LEVER_LEDGER_RECORD + str(instrument_id) + "/ledger",
            params,
            cursor=True,
        )
    ...
    def get_specific_config_info(self, instrument_id):
        return self._request_without_params(
            GET, LEVER_SPECIFIC_CONFIG + str(instrument_id) + "/availability"
        )
    ...
    def get_specific_borrow_coin(
        self, instrument_id, status="", after="", before="", limit=""
    ):
        params = {"status": status, "after": after, "before": before, "limit": limit}
        return self._request_with_params(
            GET,
            LEVER_SPECIFIC_CONFIG + str(instrument_id) + "/borrowed",
            params,
            cursor=True,
        )
    ...
    def revoke_order(self, instrument_id, order_id="", client_oid=""):
        ...
        if order_id:
            return self._request_with_params(
                POST, LEVER_REVOKE_ORDER + str(order_id), params
            )
        elif client_oid:
            return self._request_with_params(
                POST, LEVER_REVOKE_ORDER + str(client_oid), params
            )
    ...
    def get_order_info(self, instrument_id, order_id="", client_oid=""):
        ...
        if order_id:
            return self._request_with_params(
                GET, LEVER_ORDER_INFO + str(order_id), params
            )
        elif client_oid:
            return self._request_with_params(
                GET, LEVER_ORDER_INFO + str(client_oid), params
            )
    ...
    def get_leverage(self, instrument_id):
        return self._request_without_params(
            GET, LEVER_LEDGER_RECORD + str(instrument_id) + "/leverage"
        )

    def set_leverage(self, instrument_id, leverage):
        params = {"leverage": leverage}
        return self._request_with_params(
            POST, LEVER_LEDGER_RECORD + str(instrument_id) + "/leverage", params
        )

    def get_mark_price(self, instrument_id):
        return self._request_without_params(
            GET, LEVER_MARK_PRICE + str(instrument_id) + "/mark_price"
        )
