...
class OkexSpotV3(SpotAPI):
    ...
    def spot_order(
        self, instrument_id, order_price, size, order_type, side, client_oid=""
    ):
        """限价卖出
    ...
    def iceburg_order(
        self, instrument_id, side, order_type, size, algo_price, trigger_price
    ):
        """
        ...
        """
        mode = 3
        data = self.order_algo(
            instrument_id, side, mode, order_type, size, algo_price, trigger_price
        )
